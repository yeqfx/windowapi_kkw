// Practice05-07.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "pch.h"
#include "framework.h"
#include "Practice05-07.h"
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_PRACTICE0507, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PRACTICE0507));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PRACTICE0507));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_PRACTICE0507);
...
void Animation(int xPos, int yPos, HDC hdc)
{
    ...
    for (i = 0; i < 10; i++)
        Mask[i] = LoadBitmap(hInst, MAKEINTRESOURCE(IDB_BITMAP_M1 + i));
